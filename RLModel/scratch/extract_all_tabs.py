...
# Define tabs and their helper methods
tabs_config = {
    "risk_tab.dart": {
        "class": "RiskTab",
        "methods": [
    ...
    "strategy_tab.dart": {
        ...
        "methods": [
            ...
            "buildGradeTag", "buildLiveInteractiveStrategyLab", "buildMultiEpisodeStatsTable", 
            "buildCumulativeAlphaChart", "buildTradeScatterPlot", "buildParamsSimulationSliders", 
            "buildWinLossSummaryCard"
        ],
        "stateful": True,
        "live_stream": True
    },
    "ohlcv_tab.dart": {
        "class": "OHLCVTab",
        "methods": [
            "buildOHLCVChart", "buildIndicatorsToggleCard"
        ],
        "stateful": True,
        "live_stream": False
    },
    "portfolio_tab.dart": {
        "class": "PortfolioTab",
        "methods": [
            "buildPortfolioMonitor", "buildAdvancedPortfolioTable", "buildMetricSummaryGrid", 
            "buildAssetWeightsPieCard", "buildPnLBreakdownCard", "buildAssetPerformanceDetailsCard", 
            "buildSearchAndFilterBlock"
        ],
        "stateful": True,
        "live_stream": False
    },
    "terminal_tab.dart": {
        "class": "TerminalTab",
        "methods": [
            "buildAdvancedTerminal", "buildLiveInteractiveExecutionTerminal", "buildLiveModelTelemetryDashboard", 
            "buildSystemMetricsDiagnosticsPanel", "buildEmergencyStopStatusPanel", "buildModelCheckpointReloadPanel", 
    ...
    "live_stream_tab.dart": {
        "class": "LiveStreamTab",
        "methods": [
            "buildLiveStreamTab", "buildLiveExecutionLogsPanel", "buildLiveStreamStatsCard"
        ],
        "stateful": True,
        "live_stream": True
    }
    ...
    for m in cfg["methods"]:
        try:
            ...
            for field in state_fields:
                ...
                # Cleanup double prefixes if any
...
# Sort removed ranges descending to delete correctly without shifting indices
...
# Add imports for the screens in main.dart
